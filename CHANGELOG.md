...
- **`wiki-write-lao`** — copy mermaid fences verbatim (English). Wiki.js 8.8.2 errors on Lao inside graphs.
...
[1.3.3]: https://github.com/aifgrouplaos/ai-skills/releases/tag/v1.3.3
